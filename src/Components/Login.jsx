  ...
  const handleSubmitt = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://testbotbackend-8-w273.onrender.com/auth/login',
  ...
  return (
    <div>
      ...
      <div className="h-screen bg-indigo-100 flex justify-center items-center">
        <div className="lg:w-2/5 md:w-1/2 w-10/12 ">
          <form  onSubmit={handleSubmitt} className="bg-white p-10 rounded-lg shadow-lg min-w-full">
            ...
            <div>
              ...
              <input  type='password'  onChange={(e) => setPassword(e.target.value)} className="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"  name="password" id="password" placeholder="password" />
            </div>
