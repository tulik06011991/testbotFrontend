...
const Biologiya = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get('https://testbotbackend-5-oxlr.onrender.com/test/answer/get'); //https://testbotbackend-11.onrender.com
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://testbotbackend-4-hc9x.onrender.com/test/answer/post', {
        userId: user,
