...
const AdminFoydalanuvchilar = () => {
    ...
    const handleDelete = async (userId) => {
        try {
            ...
            await axios.delete(`https://testbotbackend-7.onrender.comfoydalanuvchi/user/${userId}`, {
                headers: {
    ...
    useEffect(() => {
        ...
        const getUser = async () => {
            try {
                const response = await axios.get('https://testbotbackend-7.onrender.com/foydalanuvchi/users', {
                    headers: {
                        'Content-Type': 'application/json',
                        'access_token': token
                    },
